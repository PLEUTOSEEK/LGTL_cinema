...
<html>
    ...
    <body>
        ...
        <div class="formdesign container-fluid justify-content-center col-md-5">
            ...
            <form action="insertServiceComment.php" method="POST" >
               ...
               <div class="buttonPosition col-md-12 ml-12 m-1">
                   <button type="submit" class="buttonStyle btn btn-primary btn-block col-md-7 ml-auto mr-auto rounded-pill"id="submit"name="submit">Submit</button>
               </div>
                </form>
            </form>
        </div>
